...
pub use resources::{
    baseline_credits_per_kt, credits_for_kt_sale, credits_for_materials_sale, Material,
    MaterialKind, BASELINE_CREDITS_PER_KT_HELIUM, BASELINE_CREDITS_PER_KT_IRON,
};
...
pub use ships::{ship_location_from_flat, ShipAtStar, ShipInTransit, ShipLocation};
