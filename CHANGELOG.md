...
- **Galaxy Explorer:** universe map draws **owned ships** — cyan ring + dot at **`AtStar`** positions and a **dim line** for **`InTransit`**; HUD lists **ship count** and up to five ships with grid coordinates (ly).
